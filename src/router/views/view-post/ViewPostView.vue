...
import {isLoading, loadPostData, post} from "../../../storages/posts/open-post-storage.ts";
...
<template>
  <div v-if="isLoading && post" class="pt-12 px-4 sm:p-8 mx-auto flex flex-col gap-8 max-w-[1170px]">
  ...
  <div v-else class="grid min-h-[140px] w-full place-items-center overflow-x-scroll rounded-lg p-6 lg:overflow-visible">
    <loading-svg/>
  </div>
</template>
