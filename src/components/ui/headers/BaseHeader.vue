  ...
  <nav class="shadow">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16">
      ...
      <div class="hidden sm:flex sm:items-center sm:justify-center flex-grow">
        ...
        <router-link :to="{name: 'index.user-posts'}" class="hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Мои посты</router-link>
    ...
    <div v-if="isMenuOpen" class="sm:hidden">
      <div class="px-2 pt-2 pb-3 space-y-1">
        ...
        <router-link :to="{name: 'index.user-posts'}" class="block hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Мои посты</router-link>
